...
int x=10;
float y=3.14;
std::string name='Alice'; //#include <string>
...
//输入输出
int x;std::cin>>x;
std::cout<<x<<std::endl;//#include <isostream>

//函数
int func1(int a, int b){return a+b;} //返回整数
void func2(int a, int b){std::cout<<a+b<<std::endl;} //不返回
...
//条件
if (x>0) {std::cout<<x<<std::endl;} else{std::cout<<-x<<std::endl;}
